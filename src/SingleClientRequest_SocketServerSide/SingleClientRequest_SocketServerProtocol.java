 ...
 * The SocketProtocol object contains the text of all the jokes and makes sure that the client gives the proper response to the server's statements.
 ...
 */
public class SingleClientRequest_SocketServerProtocol {
