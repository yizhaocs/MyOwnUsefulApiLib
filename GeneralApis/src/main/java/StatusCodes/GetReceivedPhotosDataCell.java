 ...
 */
public class GetReceivedPhotosDataCell implements DataCell
{
    private Long id;
    ...
    public GetReceivedPhotosDataCell()
    {

    }

    public GetReceivedPhotosDataCell(Long id, String title, String url, String fromName, Long fromId, Long createTime,
